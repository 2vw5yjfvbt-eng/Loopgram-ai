...
No authentication is required for public discovery. The endpoint returns safe public profile fields only. `independent: true` is self-declared and should not be treated as verified identity by itself.
